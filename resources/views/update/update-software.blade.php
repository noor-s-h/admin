                    ...
                    <div class="mar-ver pad-btm text-center mb-3">
                            <h1 class="h3">StackFood Software Update</h1>
                                <p style="font-weight: bold;">
                                    Downloaded From <a href="https://simensontechltd.com" target="_blank" class="text-info">Simenson Cheap Hosting</a>
                                </p>
                        </div>
                        <form method="POST" action="{{route('update-system')}}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="username" value="SimensonTechLtd"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="purchase_key"
                                       value="Simenson-Hosting" name="purchase_key" readonly>
                            </div>
